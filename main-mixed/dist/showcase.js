...
var _contractAddress = _interopRequireDefault(require("./contractAddress"));
...
function Showcase() {
  ...
  var accountChanged = /*#__PURE__*/function () {
    ...
    return function accountChanged(_x2) {
  ...
  function _app() {
    _app = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(mint) {
      var contract, provider, signer, result;
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            _context5.prev = 0;
            _context5.next = 3;
            return contract.methods.mint(1).send({
              from: accounts[0],
              value: web3.utils.toWei('0.003', 'ether')
            });
          case 3:
            contract = new _ethers.ethers.Contract(_contractAddress["default"], _abi["default"], signer);
            provider = new _ethers.ethers.providers.Web3Provider(window.ethereum);
            signer = provider.getSigner();
            _context5.next = 8;
            return contract.mint(mint);
          case 8:
  ...
  var connectWallet = /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
      var _accounts2, provider, signer, Contract, result;
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          ...
          case 16:
            _accounts2 = _context4.sent;
            if (_accounts2.length > 0) {
              accountChanged(_accounts2[0]);
            }
            _context4.next = 33;
            break;
          case 20:
  ...
  }, isConnected ? "".concat(account.substr(0, 6), "...").concat(account.substr(-4)) : "Connect Wallet"), isConnected && /*#__PURE__*/_react["default"].createElement("p", null, "Connected to ", network === "5" ? "Mainnet" : "Testnet", " with address", " ", account));
}
ReactDOM.render( /*#__PURE__*/_react["default"].createElement(_react["default"].StrictMode, null, /*#__PURE__*/_react["default"].createElement(_MyComponent["default"], null)), document.getElementById('root'));
